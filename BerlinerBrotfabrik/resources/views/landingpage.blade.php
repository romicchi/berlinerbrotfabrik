    ...
    <body>
        ...
        <section class="container mx-auto flex flex-col lg:flex-row items-center justify-center py-24 lg:py-32 lg:pl-16 lg:pr-16">
            ...
            <div class="lg:w-1/2 text-center" data-aos="fade-in" data-aos-duration="1000">
                ...
                <a href="/Aboutus" class="inline-block px-8 py-3 text-sm font-semibold leading-relaxed text-gray-800 bg-gray-200 rounded hover:bg-green-900 hover:text-gray-200" data-aos="zoom-out" data-aos-duration="1000">
        ...
        <!-- FOUR QUALITIES -->
        <div class="flex flex-wrap items-start justify-center mt-16 mb-16 lg:mt-0 lg:ml-16">
...
<div class="gb-lgreen bg-blend-multiply bg-center bg-no-repeat">
    <section class="container mx-auto flex flex-col lg:flex-row items-center justify-center py-32 lg:py-40 w-full">
        <div class="lg:w-1/2 lg:pr-16 mb-8 text-center lg:mb-0" data-aos="fade-in" data-aos-duration="1000">
            ...
            <a href="/Menu" class="inline-block px-8 py-3 text-sm font-semibold leading-relaxed text-gray-800 bg-gray-200 rounded hover:bg-green-900 hover:text-gray-200" data-aos="zoom-out" data-aos-duration="1000">
                {!! __('messages.Full Menu') !!}
            </a>
        </div>
        <div class="lg:w-1/2 flex flex-row justify-center items-center">
        <div class="mr-8 relative hover-effect sm:w-1/2 md:w-full lg:w-full lg:pr-16 mb-8 lg:mb-0 px-4 sm:px-0" data-aos="fade-up" data-aos-duration="1000">
                <img src="{{ asset('img/what-we-make.png') }}" alt="What We Make" class="rounded-lg shadow-lgreen" loading="lazy">
            </div>
        </div>
    </section>
</div>
